...
public interface OutsideFeatureDictionary {
	 ...
	 */
	ArrayList<Alphabet> getOutsideFeatureDictionaryList(
	 ...
	 * @return
	 */
	ArrayList<Alphabet> updateFilteredFeatureDictionary(
	 ...
	 */
	void stopDictionaryGrowth(ArrayList<Alphabet> outsideFeatureDictionaryList);

	/**
	 * 
	 * @return
	 */
	ArrayList<OutsideFeatureObject> getUpdatedObjectStore();
	 ...
	 *            - the created feature list
	 */
	void allowDictionaryGrowth(ArrayList<Alphabet> outsideFeatureDictionaryList);
