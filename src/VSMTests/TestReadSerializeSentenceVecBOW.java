...
public class TestReadSerializeSentenceVecBOW implements Serializable {
	...
	public static void main(String... args) throws IOException {
		...
		PrintWriter writer = new PrintWriter(
				"/group/project/vsm-afs/SICKSentenceEmbeddingsSVD/" + fileName,
				"UTF-8");
		...
		String sentenceVecDirec = VSMContant.SENTENCE_EMBEDDINGS_AVG;
		...
		VSMUtil.createMatFileSentenceEmbedBOW(sentences, evaluation, count);
