...
import VSMFeatureDictionary.VSMOutsideFeatureDictionaryVBD;
 ...
 *
 */
public class VSMExtractOutsideFeatureDictionaryVBD implements ExtractDictionary {

	private OutsideFeatureDictionary outsideFeatureDictionary;

	public VSMExtractOutsideFeatureDictionaryVBD() {

		/*
		 * Instantiating the outside feature dictionary which is empty in the
		 * beginning
		 */
		outsideFeatureDictionary = new VSMOutsideFeatureDictionaryVBD();
