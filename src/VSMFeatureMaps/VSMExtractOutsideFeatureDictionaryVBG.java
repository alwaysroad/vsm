...
import VSMFeatureDictionary.VSMOutsideFeatureDictionaryVBG;
 ...
 *
 */
public class VSMExtractOutsideFeatureDictionaryVBG implements ExtractDictionary {

	private OutsideFeatureDictionary outsideFeatureDictionary;

	public VSMExtractOutsideFeatureDictionaryVBG() {

		/*
		 * Instantiating the outside feature dictionary which is empty in the
		 * beginning
		 */
		outsideFeatureDictionary = new VSMOutsideFeatureDictionaryVBG();
