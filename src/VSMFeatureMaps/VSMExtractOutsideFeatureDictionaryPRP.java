...
import VSMFeatureDictionary.VSMOutsideFeatureDictionaryPRP;
 ...
 *
 */
public class VSMExtractOutsideFeatureDictionaryPRP implements ExtractDictionary {

	private OutsideFeatureDictionary outsideFeatureDictionary;

	public VSMExtractOutsideFeatureDictionaryPRP() {

		/*
		 * Instantiating the outside feature dictionary which is empty in the
		 * beginning
		 */
		outsideFeatureDictionary = new VSMOutsideFeatureDictionaryPRP();
