...
import VSMFeatureDictionary.VSMInsideFeatureDictionaryRB;
 ...
 *
 */
public class VSMExtractInsideFeatureDictionaryRB implements ExtractDictionary {
	 ...
	 */
	public VSMExtractInsideFeatureDictionaryRB() {

		/*
		 * Instantiating the inside feature dictionary with no features yet.
		 */
		insideFeatureDictionary = new VSMInsideFeatureDictionaryRB();
