...
import VSMFeatureDictionary.VSMInsideFeatureDictionaryPRP;
 ...
 *
 */
public class VSMExtractInsideFeatureDictionaryPRP implements ExtractDictionary {
	 ...
	 */
	public VSMExtractInsideFeatureDictionaryPRP() {

		/*
		 * Instantiating the inside feature dictionary with no features yet.
		 */
		insideFeatureDictionary = new VSMInsideFeatureDictionaryPRP();
