...
import VSMFeatureDictionary.VSMInsideFeatureDictionaryNNP;
 ...
 *
 */
public class VSMExtractInsideFeatureDictionaryNNP implements ExtractDictionary {
	 ...
	 */
	public VSMExtractInsideFeatureDictionaryNNP() {

		/*
		 * Instantiating the inside feature dictionary with no features yet.
		 */
		insideFeatureDictionary = new VSMInsideFeatureDictionaryNNP();
