 ...
 *
 */
public class VSMExtractInsideFeatureDictionaryCC implements ExtractDictionary {
	 ...
	 */
	public VSMExtractInsideFeatureDictionaryCC() {

		/*
		 * Instantiating the inside feature dictionary with no features yet.
		 */
		insideFeatureDictionary = new VSMInsideFeatureDictionaryCC();
