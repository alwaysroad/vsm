 ...
 *
 */
public class VSMExtractInsideFeatureDictionaryAUX implements ExtractDictionary {
	 ...
	 */
	public VSMExtractInsideFeatureDictionaryAUX() {

		/*
		 * Instantiating the inside feature dictionary with no features yet.
		 */
		insideFeatureDictionary = new VSMInsideFeatureDictionaryAUX();
