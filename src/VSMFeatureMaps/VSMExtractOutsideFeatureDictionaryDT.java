...
import VSMFeatureDictionary.VSMOutsideFeatureDictionaryDT;
 ...
 *
 */
public class VSMExtractOutsideFeatureDictionaryDT implements ExtractDictionary {

	private OutsideFeatureDictionary outsideFeatureDictionary;

	public VSMExtractOutsideFeatureDictionaryDT() {

		/*
		 * Instantiating the outside feature dictionary which is empty in the
		 * beginning
		 */
		outsideFeatureDictionary = new VSMOutsideFeatureDictionaryDT();
