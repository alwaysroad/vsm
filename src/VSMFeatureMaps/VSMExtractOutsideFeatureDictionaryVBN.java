...
import VSMFeatureDictionary.VSMOutsideFeatureDictionaryVBN;
 ...
 *
 */
public class VSMExtractOutsideFeatureDictionaryVBN implements ExtractDictionary {

	private OutsideFeatureDictionary outsideFeatureDictionary;

	public VSMExtractOutsideFeatureDictionaryVBN() {

		/*
		 * Instantiating the outside feature dictionary which is empty in the
		 * beginning
		 */
		outsideFeatureDictionary = new VSMOutsideFeatureDictionaryVBN();
