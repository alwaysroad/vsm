...
import VSMFeatureDictionary.VSMOutsideFeatureDictionaryPP;
 ...
 *
 */
public class VSMExtractOutsideFeatureDictionaryPP implements ExtractDictionary {

	private OutsideFeatureDictionary outsideFeatureDictionary;

	public VSMExtractOutsideFeatureDictionaryPP() {

		/*
		 * Instantiating the outside feature dictionary which is empty in the
		 * beginning
		 */
		outsideFeatureDictionary = new VSMOutsideFeatureDictionaryPP();
