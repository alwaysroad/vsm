...
import VSMFeatureDictionary.VSMOutsideFeatureDictionaryNNP;
 ...
 *
 */
public class VSMExtractOutsideFeatureDictionaryNNP implements ExtractDictionary {

	private OutsideFeatureDictionary outsideFeatureDictionary;

	public VSMExtractOutsideFeatureDictionaryNNP() {

		/*
		 * Instantiating the outside feature dictionary which is empty in the
		 * beginning
		 */
		outsideFeatureDictionary = new VSMOutsideFeatureDictionaryNNP();
