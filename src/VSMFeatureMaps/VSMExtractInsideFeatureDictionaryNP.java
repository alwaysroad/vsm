...
import VSMFeatureDictionary.VSMInsideFeatureDictionaryNP;
 ...
 *
 */
public class VSMExtractInsideFeatureDictionaryNP implements ExtractDictionary {
	 ...
	 */
	public VSMExtractInsideFeatureDictionaryNP() {

		/*
		 * Instantiating the inside feature dictionary with no features yet.
		 */
		insideFeatureDictionary = new VSMInsideFeatureDictionaryNP();
