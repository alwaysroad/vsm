...
import VSMFeatureDictionary.VSMOutsideFeatureDictionaryVP;
 ...
 *
 */
public class VSMExtractOutsideFeatureDictionaryVP implements ExtractDictionary {

	private OutsideFeatureDictionary outsideFeatureDictionary;

	public VSMExtractOutsideFeatureDictionaryVP() {

		/*
		 * Instantiating the outside feature dictionary which is empty in the
		 * beginning
		 */
		outsideFeatureDictionary = new VSMOutsideFeatureDictionaryVP();
