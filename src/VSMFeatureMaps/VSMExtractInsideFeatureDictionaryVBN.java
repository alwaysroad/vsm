...
import VSMFeatureDictionary.VSMInsideFeatureDictionaryVBN;
 ...
 *
 */
public class VSMExtractInsideFeatureDictionaryVBN implements ExtractDictionary {
	 ...
	 */
	public VSMExtractInsideFeatureDictionaryVBN() {

		/*
		 * Instantiating the inside feature dictionary with no features yet.
		 */
		insideFeatureDictionary = new VSMInsideFeatureDictionaryVBN();
