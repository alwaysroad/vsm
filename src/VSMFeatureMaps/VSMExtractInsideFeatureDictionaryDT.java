...
import VSMFeatureDictionary.VSMInsideFeatureDictionaryDT;
 ...
 *
 */
public class VSMExtractInsideFeatureDictionaryDT implements ExtractDictionary {
	 ...
	 */
	public VSMExtractInsideFeatureDictionaryDT() {

		/*
		 * Instantiating the inside feature dictionary with no features yet.
		 */
		insideFeatureDictionary = new VSMInsideFeatureDictionaryDT();
