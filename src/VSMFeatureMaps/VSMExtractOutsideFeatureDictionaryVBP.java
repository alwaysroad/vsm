...
import VSMFeatureDictionary.VSMOutsideFeatureDictionaryVBP;
 ...
 *
 */
public class VSMExtractOutsideFeatureDictionaryVBP implements ExtractDictionary {

	private OutsideFeatureDictionary outsideFeatureDictionary;

	public VSMExtractOutsideFeatureDictionaryVBP() {

		/*
		 * Instantiating the outside feature dictionary which is empty in the
		 * beginning
		 */
		outsideFeatureDictionary = new VSMOutsideFeatureDictionaryVBP();
