...
import VSMFeatureDictionary.VSMOutsideFeatureDictionaryJJ;
 ...
 *
 */
public class VSMExtractOutsideFeatureDictionaryJJ implements ExtractDictionary {

	private OutsideFeatureDictionary outsideFeatureDictionary;

	public VSMExtractOutsideFeatureDictionaryJJ() {

		/*
		 * Instantiating the outside feature dictionary which is empty in the
		 * beginning
		 */
		outsideFeatureDictionary = new VSMOutsideFeatureDictionaryJJ();
