...
import VSMFeatureDictionary.VSMInsideFeatureDictionarySBAR;
 ...
 *
 */
public class VSMExtractInsideFeatureDictionarySBAR implements ExtractDictionary {
	 ...
	 */
	public VSMExtractInsideFeatureDictionarySBAR() {

		/*
		 * Instantiating the inside feature dictionary with no features yet.
		 */
		insideFeatureDictionary = new VSMInsideFeatureDictionarySBAR();
