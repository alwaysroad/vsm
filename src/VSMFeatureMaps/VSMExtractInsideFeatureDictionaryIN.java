...
import VSMFeatureDictionary.VSMInsideFeatureDictionaryIN;
 ...
 *
 */
public class VSMExtractInsideFeatureDictionaryIN implements ExtractDictionary {
	 ...
	 */
	public VSMExtractInsideFeatureDictionaryIN() {

		/*
		 * Instantiating the inside feature dictionary with no features yet.
		 */
		insideFeatureDictionary = new VSMInsideFeatureDictionaryIN();
