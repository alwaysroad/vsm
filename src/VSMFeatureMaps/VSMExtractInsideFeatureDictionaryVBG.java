...
import VSMFeatureDictionary.VSMInsideFeatureDictionaryVBG;
 ...
 *
 */
public class VSMExtractInsideFeatureDictionaryVBG implements ExtractDictionary {
	 ...
	 */
	public VSMExtractInsideFeatureDictionaryVBG() {

		/*
		 * Instantiating the inside feature dictionary with no features yet.
		 */
		insideFeatureDictionary = new VSMInsideFeatureDictionaryVBG();
