...
import VSMFeatureDictionary.VSMInsideFeatureDictionaryNNS;
 ...
 *
 */
public class VSMExtractInsideFeatureDictionaryNNS implements ExtractDictionary {
	 ...
	 */
	public VSMExtractInsideFeatureDictionaryNNS() {

		/*
		 * Instantiating the inside feature dictionary with no features yet.
		 */
		insideFeatureDictionary = new VSMInsideFeatureDictionaryNNS();
