...
import VSMFeatureDictionary.VSMOutsideFeatureDictionaryNP;
 ...
 *
 */
public class VSMExtractOutsideFeatureDictionaryNP implements ExtractDictionary {

	private OutsideFeatureDictionary outsideFeatureDictionary;

	public VSMExtractOutsideFeatureDictionaryNP() {

		/*
		 * Instantiating the outside feature dictionary which is empty in the
		 * beginning
		 */
		outsideFeatureDictionary = new VSMOutsideFeatureDictionaryNP();
