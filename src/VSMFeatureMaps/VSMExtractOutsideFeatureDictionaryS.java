...
import VSMFeatureDictionary.VSMOutsideFeatureDictionaryS;
 ...
 *
 */
public class VSMExtractOutsideFeatureDictionaryS implements ExtractDictionary {

	private OutsideFeatureDictionary outsideFeatureDictionary;

	public VSMExtractOutsideFeatureDictionaryS() {

		/*
		 * Instantiating the outside feature dictionary which is empty in the
		 * beginning
		 */
		outsideFeatureDictionary = new VSMOutsideFeatureDictionaryS();
