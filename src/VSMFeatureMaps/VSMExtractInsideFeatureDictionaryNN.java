...
import VSMFeatureDictionary.VSMInsideFeatureDictionaryNN;
 ...
 *
 */
public class VSMExtractInsideFeatureDictionaryNN implements ExtractDictionary {
	 ...
	 */
	public VSMExtractInsideFeatureDictionaryNN() {

		/*
		 * Instantiating the inside feature dictionary with no features yet.
		 */
		insideFeatureDictionary = new VSMInsideFeatureDictionaryNN();
