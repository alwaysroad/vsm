...
import VSMFeatureDictionary.VSMInsideFeatureDictionaryPP;
 ...
 *
 */
public class VSMExtractInsideFeatureDictionaryPP implements ExtractDictionary {
	 ...
	 */
	public VSMExtractInsideFeatureDictionaryPP() {

		/*
		 * Instantiating the inside feature dictionary with no features yet.
		 */
		insideFeatureDictionary = new VSMInsideFeatureDictionaryPP();
