...
import VSMFeatureDictionary.VSMInsideFeatureDictionaryVP;
 ...
 *
 */
public class VSMExtractInsideFeatureDictionaryVP implements ExtractDictionary {
	 ...
	 */
	public VSMExtractInsideFeatureDictionaryVP() {

		/*
		 * Instantiating the inside feature dictionary with no features yet.
		 */
		insideFeatureDictionary = new VSMInsideFeatureDictionaryVP();
