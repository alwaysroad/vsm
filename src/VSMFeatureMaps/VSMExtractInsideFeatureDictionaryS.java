...
import VSMFeatureDictionary.VSMInsideFeatureDictionaryS;
 ...
 *
 */
public class VSMExtractInsideFeatureDictionaryS implements ExtractDictionary {
	 ...
	 */
	public VSMExtractInsideFeatureDictionaryS() {

		/*
		 * Instantiating the inside feature dictionary with no features yet.
		 */
		insideFeatureDictionary = new VSMInsideFeatureDictionaryS();
