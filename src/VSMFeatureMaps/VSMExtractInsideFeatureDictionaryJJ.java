...
import VSMFeatureDictionary.VSMInsideFeatureDictionaryJJ;
 ...
 *
 */
public class VSMExtractInsideFeatureDictionaryJJ implements ExtractDictionary {
	 ...
	 */
	public VSMExtractInsideFeatureDictionaryJJ() {

		/*
		 * Instantiating the inside feature dictionary with no features yet.
		 */
		insideFeatureDictionary = new VSMInsideFeatureDictionaryJJ();
