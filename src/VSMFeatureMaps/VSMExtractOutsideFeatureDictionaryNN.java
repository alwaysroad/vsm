...
import VSMFeatureDictionary.VSMOutsideFeatureDictionaryNN;
 ...
 *
 */
public class VSMExtractOutsideFeatureDictionaryNN implements ExtractDictionary {

	private OutsideFeatureDictionary outsideFeatureDictionary;

	public VSMExtractOutsideFeatureDictionaryNN() {

		/*
		 * Instantiating the outside feature dictionary which is empty in the
		 * beginning
		 */
		outsideFeatureDictionary = new VSMOutsideFeatureDictionaryNN();
