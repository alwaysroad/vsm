...
import VSMFeatureDictionary.VSMOutsideFeatureDictionaryNNS;
 ...
 *
 */
public class VSMExtractOutsideFeatureDictionaryNNS implements ExtractDictionary {

	private OutsideFeatureDictionary outsideFeatureDictionary;

	public VSMExtractOutsideFeatureDictionaryNNS() {

		/*
		 * Instantiating the outside feature dictionary which is empty in the
		 * beginning
		 */
		outsideFeatureDictionary = new VSMOutsideFeatureDictionaryNNS();
