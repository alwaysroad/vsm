...
import VSMFeatureDictionary.VSMOutsideFeatureDictionaryRB;
 ...
 *
 */
public class VSMExtractOutsideFeatureDictionaryRB implements ExtractDictionary {

	private OutsideFeatureDictionary outsideFeatureDictionary;

	public VSMExtractOutsideFeatureDictionaryRB() {

		/*
		 * Instantiating the outside feature dictionary which is empty in the
		 * beginning
		 */
		outsideFeatureDictionary = new VSMOutsideFeatureDictionaryRB();
