...
import VSMFeatureDictionary.VSMInsideFeatureDictionaryVBP;
 ...
 *
 */
public class VSMExtractInsideFeatureDictionaryVBP implements ExtractDictionary {
	 ...
	 */
	public VSMExtractInsideFeatureDictionaryVBP() {

		/*
		 * Instantiating the inside feature dictionary with no features yet.
		 */
		insideFeatureDictionary = new VSMInsideFeatureDictionaryVBP();
