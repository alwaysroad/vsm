...
import VSMFeatureDictionary.VSMOutsideFeatureDictionarySBAR;
 ...
 *
 */
public class VSMExtractOutsideFeatureDictionarySBAR implements ExtractDictionary {

	private OutsideFeatureDictionary outsideFeatureDictionary;

	public VSMExtractOutsideFeatureDictionarySBAR() {

		/*
		 * Instantiating the outside feature dictionary which is empty in the
		 * beginning
		 */
		outsideFeatureDictionary = new VSMOutsideFeatureDictionarySBAR();
