...
public class VSMFeatureMatrixNNP {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm/sparsefeaturevectors/NNP/";
		/*
		...
		if (!serFiles.isEmpty()) {
			 ...
			 * there
			 */
			matrices = VSMUtil.deserializeCCAVariantsRun("NNP");
			VSMUtil.writeEigenDictInside(matrices, "NNP", d);
			VSMUtil.writeEigenDictOutside(matrices, "NNP", dprime);
			matrices = null;
			PsiTPhi = null;
			PhiTPhi = null;
			PsiTPsi = null;
