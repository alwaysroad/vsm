...
public class VSMSemanticProjectionMatricesCD {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		System.out.println("Hi: I am CDSem");
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm/wordfeaturevec/CD/";
		/*
		...
		// "/Users/sameerkhurana10/Documents/serialization/CD")
		// .listFiles();
		...
		if (!serFiles.isEmpty()) {
			 ...
			 * there
			 */
			matrices = VSMUtil.deserializeCCAVariantsRunSem("CD");
			VSMUtil.writeEigenDictInsideSemantic(matrices, "CD", d);
			VSMUtil.writeEigenDictOutsideSem(matrices, "CD", dprime);
			matrices = null;
			PsiTPhi = null;
			PhiTPhi = null;
			PsiTPsi = null;
