...
public class VSMSemanticProjectionMatricesNP {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		String dictionaryPath = VSMContant.WORD_DICT;
		/*
		...
		System.out.println("***word dictionary size***" + d);
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm.restored/semanticfeaturevecs/NP/";
		...
		System.out.println("**no of samples**" + serFiles.size());
		...
		if (!serFiles.isEmpty()) {
			 ...
			 * there
			 */
			matrices = VSMUtil.deserializeCCAVariantsRunSem("NP");
			VSMUtil.writeEigenDictInsideSemantic(matrices, "NP", d);
			VSMUtil.writeEigenDictOutsideSem(matrices, "NP", dprime);
			matrices = null;
			PsiTPhi = null;
			PhiTPhi = null;
			PsiTPsi = null;
