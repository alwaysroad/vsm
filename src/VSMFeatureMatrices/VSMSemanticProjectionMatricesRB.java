...
public class VSMSemanticProjectionMatricesRB {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm/semanticfeaturevecs/RB/";
		/*
		...
		// "/Users/sameerkhurana10/Documents/serialization/RB")
		// .listFiles();
		...
		if (!serFiles.isEmpty()) {
			...
			VSMUtil.writeCovarMatrixSem(PsiTPsi, "RB");
			VSMUtil.writeCovarMatrixSem(PsiTPhi, "RB");
			VSMUtil.writeCovarMatrixSem(PhiTPhi, "RB");
			VSMUtil.writeCovarMatrixSem(PhiTPsi, "RB");
			 ...
			 * there
			 */
			matrices = VSMUtil.deserializeCCAVariantsRunSem("RB");
			VSMUtil.writeEigenDictInsideSemantic(matrices, "RB", d);
			VSMUtil.writeEigenDictOutsideSem(matrices, "RB", dprime);
			matrices = null;
			PsiTPhi = null;
			PhiTPhi = null;
			PsiTPsi = null;
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValuesSem(s, "RB");
