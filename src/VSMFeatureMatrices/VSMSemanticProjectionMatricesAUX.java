...
public class VSMSemanticProjectionMatricesAUX {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		System.out.println("Hi: I am AUXSem");
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm/wordfeaturevec/AUX/";
		/*
		...
		// "/Users/sameerkhurana10/Documents/serialization/AUX")
		// .listFiles();
		...
		if (!serFiles.isEmpty()) {
			...
			System.gc();
			/*
			 * Getting the  the similarity scoressvd template object that has utility methods to do
			 ...
			 * there
			 */
			matrices = VSMUtil.deserializeCCAVariantsRunSem("AUX");
			VSMUtil.writeEigenDictInsideSemantic(matrices, "AUX", d);
			VSMUtil.writeEigenDictOutsideSem(matrices, "AUX", dprime);
			matrices = null;
			PsiTPhi = null;
			PhiTPhi = null;
			PsiTPsi = null;
