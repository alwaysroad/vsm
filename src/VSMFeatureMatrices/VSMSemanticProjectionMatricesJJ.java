...
public class VSMSemanticProjectionMatricesJJ {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		System.out.println("Hi: I am JJSem");
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm/semanticfeaturevecs/JJ/";
		/*
		...
		// "/Users/sameerkhurana10/Documents/serialization/JJ")
		// .listFiles();
		...
		if (!serFiles.isEmpty()) {
			...
			VSMUtil.writeCovarMatrixSem(PsiTPsi, "JJ");
			VSMUtil.writeCovarMatrixSem(PsiTPhi, "JJ");
			VSMUtil.writeCovarMatrixSem(PhiTPhi, "JJ");
			VSMUtil.writeCovarMatrixSem(PhiTPsi, "JJ");
			 ...
			 * there
			 */
			matrices = VSMUtil.deserializeCCAVariantsRunSem("JJ");
			VSMUtil.writeEigenDictInsideSemantic(matrices, "JJ", d);
			VSMUtil.writeEigenDictOutsideSem(matrices, "JJ", dprime);
			matrices = null;
			PsiTPhi = null;
			PhiTPhi = null;
			PsiTPsi = null;
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValuesSem(s, "JJ");
