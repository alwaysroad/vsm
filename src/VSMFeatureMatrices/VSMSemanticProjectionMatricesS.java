...
public class VSMSemanticProjectionMatricesS {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm/semanticfeaturevecs/S/";
		/*
		...
		// "/Users/sameerkhurana10/Documents/serialization/S")
		// .listFiles();
		...
		if (!serFiles.isEmpty()) {
			 ...
			 * there
			 */
			matrices = VSMUtil.deserializeCCAVariantsRunSem("S");
			VSMUtil.writeEigenDictInsideSemantic(matrices, "S", d);
			VSMUtil.writeEigenDictOutsideSem(matrices, "S", dprime);
			matrices = null;
			PsiTPhi = null;
			PhiTPhi = null;
			PsiTPsi = null;
