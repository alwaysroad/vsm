...
public class VSMSemanticProjectionMatricesVP {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm/semanticfeaturevecs/VP/";
		/*
		...
		// "/Users/sameerkhurana10/Documents/serialization/VP")
		// .listFiles();
		...
		if (!serFiles.isEmpty()) {
			 ...
			 * there
			 */
			matrices = VSMUtil.deserializeCCAVariantsRunSem("VP");
			VSMUtil.writeEigenDictInsideSemantic(matrices, "VP", d);
			VSMUtil.writeEigenDictOutsideSem(matrices, "VP", dprime);
			matrices = null;
			PsiTPhi = null;
			PhiTPhi = null;
			PsiTPsi = null;
