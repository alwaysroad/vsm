...
public class VSMFeatureMatrixNP {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm/sparsefeaturevectors/NP/";
		/*
		...
		if (!serFiles.isEmpty()) {
			...
			for (String serFilePath : serFiles) {
				...
				if (vectorBean != null) {
					...
					count++;
					/*
					 * Only take the first 300000 feature vectors
					 */
					if (count == 299999) {
						break;
					}
			 ...
			 * there
			 */
			matrices = VSMUtil.deserializeCCAVariantsRun("NP");
			VSMUtil.writeEigenDictInside(matrices, "NP", d);
			VSMUtil.writeEigenDictOutside(matrices, "NP", dprime);
			matrices = null;
			PsiTPhi = null;
			PhiTPhi = null;
			PsiTPsi = null;
