...
public class VSMSemanticProjectionMatricesVBD {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm/semanticfeaturevecs/VBD/";
		/*
		...
		// "/Users/sameerkhurana10/Documents/serialization/VBD")
		// .listFiles();
		...
		if (!serFiles.isEmpty()) {
			 ...
			 * there
			 */
			matrices = VSMUtil.deserializeCCAVariantsRunSem("VBD");
			VSMUtil.writeEigenDictInsideSemantic(matrices, "VBD", d);
			VSMUtil.writeEigenDictOutsideSem(matrices, "VBD", dprime);
			matrices = null;
			PsiTPhi = null;
			PhiTPhi = null;
			PsiTPsi = null;
