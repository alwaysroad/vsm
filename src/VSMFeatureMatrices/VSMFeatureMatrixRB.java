...
public class VSMFeatureMatrixRB {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm/sparsefeaturevectors/RB/";
		/*
		...
		if (!serFiles.isEmpty()) {
			 ...
			 * there
			 */
			matrices = VSMUtil.deserializeCCAVariantsRun("RB");
			VSMUtil.writeEigenDictInside(matrices, "RB", d);
			VSMUtil.writeEigenDictOutside(matrices, "RB", dprime);
			matrices = null;
			PsiTPhi = null;
			PhiTPhi = null;
			PsiTPsi = null;
