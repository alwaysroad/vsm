...
public class VSMSemanticProjectionMatricesIN {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm/semanticfeaturevecs/IN/";
		/*
		...
		// "/Users/sameerkhurana10/Documents/serialization/IN")
		// .listFiles();
		...
		if (!serFiles.isEmpty()) {
			...
			for (String serFilePath : serFiles) {
				...
				if (vectorBean != null) {
					...
					/*
				VSMSemanticProjectionMatricesCD	 * Inside sparse matrix formation for the particular node.
					 */
			 ...
			 * there
			 */
			matrices = VSMUtil.deserializeCCAVariantsRunSem("IN");
			VSMUtil.writeEigenDictInsideSemantic(matrices, "IN", d);
			VSMUtil.writeEigenDictOutsideSem(matrices, "IN", dprime);
			matrices = null;
			PsiTPhi = null;
			PhiTPhi = null;
			PsiTPsi = null;
