...
public class VSMSemanticProjectionMatrices {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm/wordfeaturevec/LS/";
		/*
		...
		if (!serFiles.isEmpty()) {
			 ...
			 * there
			 */
			matrices = VSMUtil.deserializeCCAVariantsRunSem("LS");
			VSMUtil.writeEigenDictInsideSemantic(matrices, "LS", d);
			VSMUtil.writeEigenDictOutsideSem(matrices, "LS", dprime);
			matrices = null;
			PsiTPhi = null;
			PhiTPhi = null;
			PsiTPsi = null;
