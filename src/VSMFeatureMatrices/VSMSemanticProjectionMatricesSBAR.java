...
public class VSMSemanticProjectionMatricesSBAR {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm/semanticfeaturevecs/SBAR/";
		/*
		...
		// "/Users/sameerkhurana10/Documents/serialization/SBAR")
		// .listFiles();
		...
		if (!serFiles.isEmpty()) {
			...
			for (String serFilePath : serFiles) {
				...
				if (vectorBean != null) {
					...
					if (phi != null && psi != null) {
						...
						/*
						 * Outside sparse matrix formation for the particular
						 * node
						 */
						...
						/*
						 * The number of samples are stored in the count
						 * variable. Used when writing the projection matrices
						 * in a file
						 */
						count++;
						/*
						 * Take the 200000 samples
						 */
						if (count == 199999) {
							break;
						}
						...
						System.out
								.println("***The outside feature vector was null because the non-terminal is at the root of the tree***");
					}
				} else {
					System.out
			 ...
			 * there
			 */
			matrices = VSMUtil.deserializeCCAVariantsRunSem("SBAR");
			VSMUtil.writeEigenDictInsideSemantic(matrices, "SBAR", d);
			VSMUtil.writeEigenDictOutsideSem(matrices, "SBAR", dprime);
			matrices = null;
			PsiTPhi = null;
			PhiTPhi = null;
			PsiTPsi = null;
