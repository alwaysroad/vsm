...
public class VSMFeatureMatrixSBAR {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		System.out.println("Hi: I am SBAR");
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm/sparsefeaturevectors/SBAR/";
		/*
		...
		if (!serFiles.isEmpty()) {
			 ...
			 * there
			 */
			matrices = VSMUtil.deserializeCCAVariantsRun("SBAR");
			VSMUtil.writeEigenDictInside(matrices, "SBAR", d);
			VSMUtil.writeEigenDictOutside(matrices, "SBAR", dprime);
			matrices = null;
			PsiTPhi = null;
			PhiTPhi = null;
			PsiTPsi = null;
