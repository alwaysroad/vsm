...
public class VSMFeatureMatrixVBD {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		System.out.println("Hi: I am VBD");
		 ...
		 * dprime
		 */
		// String dictionaryPath =java -Xms10g -Xmx100g -cp ".:/afs/inf.ed.ac.uk/user/s14/s1444025/Documents/workspace/spectralembeddings/lib/*"
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm/sparsefeaturevectors/VBD/";
		/*
		...
		if (!serFiles.isEmpty()) {
			 ...
			 * outside feature vectors pertaining to a node and then storing
			 * them in a feature matrix
			 */
			System.out
			...
			for (String serFilePath : serFiles) {
				...
				/*
				 * Reading the feature vector bean at that path to get the
				 * inside and outside feature vector
				 */
				...
				if (vectorBean != null) {
					 ...
					 * TODO need to test this getIndex first, that whether it
					 * returns +1 index or the ones we wanted to store
					 */
					...
					count++;
					/*
					 * Only take the first 5000 feature vectors
					 */
					if (count == 99999) {
						break;
					}
			 ...
			 * there
			 */
			matrices = VSMUtil.deserializeCCAVariantsRun("VBD");
			VSMUtil.writeEigenDictInside(matrices, "VBD", d);
			VSMUtil.writeEigenDictOutside(matrices, "VBD", dprime);
			matrices = null;
			PsiTPhi = null;
			PhiTPhi = null;
			PsiTPsi = null;
	...
	public static void serializeCCAVariantsRun(String directoryName) {
		...
		String fileDirPath = "/afs/inf.ed.ac.uk/group/project/vsm/serializedprojections/"
				+ directoryName;
