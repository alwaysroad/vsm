...
public class VSMFeatureMatrixDT {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm/sparsefeaturevectors/DT/";
		/*
		...
		if (!serFiles.isEmpty()) {
			 ...
			 * there
			 */
			matrices = VSMUtil.deserializeCCAVariantsRun("DT");
			VSMUtil.writeEigenDictInside(matrices, "DT", d);
			VSMUtil.writeEigenDictOutside(matrices, "DT", dprime);
			matrices = null;
			PsiTPhi = null;
			PhiTPhi = null;
			PsiTPsi = null;
