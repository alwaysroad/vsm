...
public class VSMFeatureMatrixJJ {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm/sparsefeaturevectors/JJ/";
		/*
		...
		if (!serFiles.isEmpty()) {
			 ...
			 * there
			 */
			matrices = VSMUtil.deserializeCCAVariantsRun("JJ");
			VSMUtil.writeEigenDictInside(matrices, "JJ", d);
			VSMUtil.writeEigenDictOutside(matrices, "JJ", dprime);
			matrices = null;
			PsiTPhi = null;
			PhiTPhi = null;
			PsiTPsi = null;
