...
public class VSMFeatureMatrixNNS {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm/sparsefeaturevectors/NNS/";
		/*
		...
		if (!serFiles.isEmpty()) {
			 ...
			 * there
			 */
			matrices = VSMUtil.deserializeCCAVariantsRun("NNS");
			VSMUtil.writeEigenDictInside(matrices, "NNS", d);
			VSMUtil.writeEigenDictOutside(matrices, "NNS", dprime);
			matrices = null;
			PsiTPhi = null;
			PhiTPhi = null;
			PsiTPsi = null;
