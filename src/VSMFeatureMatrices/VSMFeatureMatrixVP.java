...
public class VSMFeatureMatrixVP {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm/sparsefeaturevectors/VP/";
		/*
		...
		if (!serFiles.isEmpty()) {
			 ...
			 * there
			 */
			matrices = VSMUtil.deserializeCCAVariantsRun("VP");
			VSMUtil.writeEigenDictInside(matrices, "VP", d);
			VSMUtil.writeEigenDictOutside(matrices, "VP", dprime);
			matrices = null;
			PsiTPhi = null;
			PhiTPhi = null;
			PsiTPsi = null;
