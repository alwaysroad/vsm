...
public class SentenceFeatureVectorsTrial {
	...
	private static void serializeVectorBean(int treeCount) {
		nodeCount++;
		serializeVectorBean(vectorBean, treeCount, nodeCount);

	}

	private static void serializeVectorBean(VSMFeatureVectorBean vectorBean,
