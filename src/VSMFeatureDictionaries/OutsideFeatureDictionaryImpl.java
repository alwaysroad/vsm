...
public class OutsideFeatureDictionaryImpl implements OutsideFeatureDictionary {
	...
	public OutsideFeatureDictionaryImpl(String nonTerminal, Logger logger)
		...
		writer = new PrintWriter(new FileOutputStream(new File(
				writeAtPath.getAbsolutePath() + "/outsidedict.txt"), true));
