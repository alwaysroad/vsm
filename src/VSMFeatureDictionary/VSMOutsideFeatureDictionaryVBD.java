...
public class VSMOutsideFeatureDictionaryVBD implements OutsideFeatureDictionary {
	...
	public VSMOutsideFeatureDictionaryVBD() {
			...
			if (syntaxTree != null) {
				...
				while (syntaxTreeIt.hasNext()) {
					...
					if (!insideTree.isLeaf()
							&& insideTree.getLabel().equalsIgnoreCase("VBD")) {
						/*
