...
public class VSMFeatureVectorsNNP {
	...
	public static void main(String... args) throws Exception {
		...
		if (args.length > 2) {
			 ...
			 * features
			 */
			featureDictionarySyn = VSMContant.FEATURE_DICT_NNP;
			 ...
			 */
			//treeCountObjLoc = "/afs/inf.ed.ac.uk/group/project/vsm/countmaptest/treecount.ser";
		}
			...
			if (syntaxTree != null) {
				...
				while (nodeTrees.hasNext()) {
					...
					if (!insideTree.isLeaf()
							&& insideTree.getLabel().equalsIgnoreCase("NNP")) {
		...
		System.out.println("****Done with NNP*****");
	}
}
