...
public class VSMFeatureVectorsVBN {
	...
	public static void main(String... args) throws Exception {
		...
		if (args.length > 2) {
			 ...
			 * features
			 */
			featureDictionarySyn = VSMContant.FEATURE_DICT_VBN;
			...
			if (syntaxTree != null) {
				...
				while (nodeTrees.hasNext()) {
					...
					if (!insideTree.isLeaf()
							&& insideTree.getLabel().equalsIgnoreCase("VBN")) {
		...
		System.out.println("****Done with VBN*****");
	}
}
