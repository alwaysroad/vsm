...
public class VSMFeatureVectorsAUX {
	...
	public static void main(String... args) throws Exception {
		...
		if (args.length > 2) {
			 ...
			 * features
			 */
			featureDictionarySyn = VSMContant.FEATURE_DICT_AUX;
			...
			if (syntaxTree != null) {
				...
				while (nodeTrees.hasNext()) {
					...
					if (!insideTree.isLeaf()
							&& insideTree.getLabel().equalsIgnoreCase("AUX")) {
		...
		System.out.println("****Done with AUX*****");
	}
}
