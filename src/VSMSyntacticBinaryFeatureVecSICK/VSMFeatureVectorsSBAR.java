...
public class VSMFeatureVectorsSBAR {
	...
	public static void main(String... args) throws Exception {
		...
		if (args.length > 2) {
			 ...
			 * features
			 */
			featureDictionarySyn = VSMContant.FEATURE_DICT_SBAR;
			...
			if (syntaxTree != null) {
				...
				while (nodeTrees.hasNext()) {
					...
					if (!insideTree.isLeaf()
							&& insideTree.getLabel().equalsIgnoreCase("SBAR")) {
		...
		System.out.println("****Done with SBAR*****");
	}
}
