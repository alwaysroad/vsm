...
public class VSMSentenceEmbeddingCooccurence {
	...
	public static void main(String[] args) {
		...
		for (File sentence : sentences) {
			...
			no.uib.cipr.matrix.Vector[] embeddedFeatureVectors = new DenseVector[28];
			...
			embeddedFeatureVectors[12] = prpinSem;
			embeddedFeatureVectors[13] = prpoutSem;

			// embeddedFeatureVectors[28] = sbarinSyn;
			// embeddedFeatureVectors[29] = sbaroutSyn;
			embeddedFeatureVectors[14] = sbarinSem;
			embeddedFeatureVectors[15] = sbaroutSem;
			...
			embeddedFeatureVectors[16] = vbpinSem;
			embeddedFeatureVectors[17] = vbpoutSem;
			...
			embeddedFeatureVectors[20] = npinSem;
			embeddedFeatureVectors[21] = npoutSem;

			embeddedFeatureVectors[22] = vpinSem;
			embeddedFeatureVectors[23] = vpoutSem;

			embeddedFeatureVectors[24] = ppinSem;
			embeddedFeatureVectors[25] = ppoutSem;

			embeddedFeatureVectors[26] = vbninSem;
			embeddedFeatureVectors[27] = vbnoutSem;
			 ...
			 */
			VSMSerializeSentenceVectorBean.sentenceVectorBean(vecBean,
					sentence.getName());
