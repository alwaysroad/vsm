...
public class VSMSentenceEmbeddingCooccurencePhraseInsideWords {
	...
	public static void main(String[] args) {
		...
		for (File sentence : sentences) {
			 ...
			 */
			no.uib.cipr.matrix.Vector sentenceVector = new DenseVector(250);

			no.uib.cipr.matrix.Vector[] embeddedFeatureVectors = new DenseVector[5];
			...
			embeddedFeatureVectors[1] = sbarinSem;
			...
			embeddedFeatureVectors[3] = vpinSem;
			// embeddedFeatureVectors[7] = vpoutSem;

			embeddedFeatureVectors[4] = ppinSem;
			// embeddedFeatureVectors[9] = ppoutSem;

			// embeddedFeatureVectors[5] = vbninSem;
			 ...
			 */
			VSMSerializeSentenceVectorBean.sentenceVectorBeanPhrasesInside(
					vecBean, sentence.getName());
