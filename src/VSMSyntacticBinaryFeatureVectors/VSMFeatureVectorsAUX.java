...
public class VSMFeatureVectorsAUX {
	...
	public static void main(String... args) throws Exception {
		...
		if (args.length > 2) {
			...
			featureDictionary = "/afs/inf.ed.ac.uk/group/project/vsm/featuredictionary/aux/dictionary.ser";
			/*
			...
			countMapLoc = "/afs/inf.ed.ac.uk/group/project/vsm/countmapnodesamples/countMap.ser";
		}
		 ...
		 */
		VSMSerializeFeatureVectorBean serializeBean = null;
				...
				if (syntaxTree != null) {
					...
					while (nodeTrees.hasNext()) {
						...
						if (!insideTree.isLeaf()
							...
							/*
							 * Break the loop when the required samples are
							 * collected
							 */
