...
public class SentenceEmbedding {
	...
	static {
		LOGGER = VSMLogger.setup(SentenceEmbedding.class.getName());
	}
	...
	public static void main(String[] args) {
		...
		sentences = VSMUtil
				.getSICKSentenceDirectories(VSMContant.SICK_EMBEDDED_CHUNK_VECS);
	...
	private static void formSenetenceEmbedding() {
		System.out.println(embeddedFeatureVectors.length);
		int i = 0;
		...
		System.out.println(sentenceEmbedding);
