...
public class VSMFeatureVectorsWordNNP {
	...
	public static void main(String... args) throws Exception {
		...
		VSMUtil.writeCovarMatrixSem(PsiTPsi, "NNP");
		VSMUtil.writeCovarMatrixSem(PsiTPhi, "NNP");
		VSMUtil.writeCovarMatrixSem(PhiTPhi, "NNP");
		VSMUtil.writeCovarMatrixSem(PhiTPsi, "NNP");
		 ...
		 */
		matrices = VSMUtil.deserializeCCAVariantsRunSem("NNP");
		VSMUtil.writeEigenDictInsideSemantic(matrices, "NNP", d);
		VSMUtil.writeEigenDictOutsideSem(matrices, "NNP", dprime);
		matrices = null;
		PsiTPhi = null;
		PhiTPhi = null;
		PsiTPsi = null;
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValuesSem(s, "NNP");
