...
public class VSMFeatureVectorsWordPRP {
	...
	public static void main(String... args) throws Exception {
		...
		VSMUtil.writeCovarMatrixSem(PsiTPsi, "PRP");
		VSMUtil.writeCovarMatrixSem(PsiTPhi, "PRP");
		VSMUtil.writeCovarMatrixSem(PhiTPhi, "PRP");
		VSMUtil.writeCovarMatrixSem(PhiTPsi, "PRP");
		 ...
		 */
		matrices = VSMUtil.deserializeCCAVariantsRunSem("PRP");
		VSMUtil.writeEigenDictInsideSemantic(matrices, "PRP", d);
		VSMUtil.writeEigenDictOutsideSem(matrices, "PRP", dprime);
		matrices = null;
		PsiTPhi = null;
		PhiTPhi = null;
		PsiTPsi = null;
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValuesSem(s, "PRP");
