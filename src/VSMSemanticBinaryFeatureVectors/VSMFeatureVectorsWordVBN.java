...
public class VSMFeatureVectorsWordVBN {
	...
	public static void main(String... args) throws Exception {
		...
		VSMUtil.writeCovarMatrixSem(PsiTPsi, "VBN");
		VSMUtil.writeCovarMatrixSem(PsiTPhi, "VBN");
		VSMUtil.writeCovarMatrixSem(PhiTPhi, "VBN");
		VSMUtil.writeCovarMatrixSem(PhiTPsi, "VBN");
		 ...
		 */
		matrices = VSMUtil.deserializeCCAVariantsRunSem("VBN");
		VSMUtil.writeEigenDictInsideSemantic(matrices, "VBN", d);
		VSMUtil.writeEigenDictOutsideSem(matrices, "VBN", dprime);
		matrices = null;
		PsiTPhi = null;
		PhiTPhi = null;
		PsiTPsi = null;
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValuesSem(s, "VBN");
