...
public class VSMFeatureVectorsWordVP {
	...
	public static void main(String... args) throws Exception {
		...
		VSMUtil.writeCovarMatrixSem(PsiTPsi, "VP");
		VSMUtil.writeCovarMatrixSem(PsiTPhi, "VP");
		VSMUtil.writeCovarMatrixSem(PhiTPhi, "VP");
		VSMUtil.writeCovarMatrixSem(PhiTPsi, "VP");
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValuesSem(s, "VP");
