...
public class VSMFeatureVectorsWordPP {
	...
	public static void main(String... args) throws Exception {
		...
		VSMUtil.writeCovarMatrixSem(PsiTPsi, "PP");
		VSMUtil.writeCovarMatrixSem(PsiTPhi, "PP");
		VSMUtil.writeCovarMatrixSem(PhiTPhi, "PP");
		VSMUtil.writeCovarMatrixSem(PhiTPsi, "PP");
		 ...
		 */
		matrices = VSMUtil.deserializeCCAVariantsRunSem("PP");
		VSMUtil.writeEigenDictInsideSemantic(matrices, "PP", d);
		VSMUtil.writeEigenDictOutsideSem(matrices, "PP", dprime);
		matrices = null;
		PsiTPhi = null;
		PhiTPhi = null;
		PsiTPsi = null;
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValuesSem(s, "PP");
