...
public class VSMFeatureVectorsWordSBAR {
	...
	public static void main(String... args) throws Exception {
		...
		VSMUtil.writeCovarMatrixSem(PsiTPsi, "SBAR");
		VSMUtil.writeCovarMatrixSem(PsiTPhi, "SBAR");
		VSMUtil.writeCovarMatrixSem(PhiTPhi, "SBAR");
		VSMUtil.writeCovarMatrixSem(PhiTPsi, "SBAR");
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValuesSem(s, "SBAR");
