...
public class VSMFeatureVectorsWordS {
	...
	public static void main(String... args) throws Exception {
		...
		VSMUtil.writeCovarMatrixSem(PsiTPsi, "S");
		VSMUtil.writeCovarMatrixSem(PsiTPhi, "S");
		VSMUtil.writeCovarMatrixSem(PhiTPhi, "S");
		VSMUtil.writeCovarMatrixSem(PhiTPsi, "S");
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValuesSem(s, "S");
