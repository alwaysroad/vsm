...
public class VSMFeatureVectorsWordVBG {
	...
	public static void main(String... args) throws Exception {
		...
		VSMUtil.writeCovarMatrixSem(PsiTPsi, "VBG");
		VSMUtil.writeCovarMatrixSem(PsiTPhi, "VBG");
		VSMUtil.writeCovarMatrixSem(PhiTPhi, "VBG");
		VSMUtil.writeCovarMatrixSem(PhiTPsi, "VBG");
		 ...
		 */
		matrices = VSMUtil.deserializeCCAVariantsRunSem("VBG");
		VSMUtil.writeEigenDictInsideSemantic(matrices, "VBG", d);
		VSMUtil.writeEigenDictOutsideSem(matrices, "VBG", dprime);
		matrices = null;
		PsiTPhi = null;
		PhiTPhi = null;
		PsiTPsi = null;
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValuesSem(s, "VBG");
