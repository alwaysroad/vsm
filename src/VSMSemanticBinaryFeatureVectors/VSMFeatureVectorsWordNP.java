...
public class VSMFeatureVectorsWordNP {
	...
	public static void main(String... args) throws Exception {
		 ...
		 * features
		 */
		featureDictionary = VSMContant.WORD_DICT;
		/*
		...
		VSMUtil.writeCovarMatrixSem(PsiTPsi, "NP");
		VSMUtil.writeCovarMatrixSem(PsiTPhi, "NP");
		VSMUtil.writeCovarMatrixSem(PhiTPhi, "NP");
		VSMUtil.writeCovarMatrixSem(PhiTPsi, "NP");
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValuesSem(s, "NP");
