...
public class VSMFeatureVectorsWordIN {
	...
	public static void main(String... args) throws Exception {
		...
		VSMUtil.writeCovarMatrixSem(PsiTPsi, "IN");
		VSMUtil.writeCovarMatrixSem(PsiTPhi, "IN");
		VSMUtil.writeCovarMatrixSem(PhiTPhi, "IN");
		VSMUtil.writeCovarMatrixSem(PhiTPsi, "IN");
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValuesSem(s, "IN");
