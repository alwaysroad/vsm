...
public class VSMFeatureVectorsWordVBP {
	...
	public static void main(String... args) throws Exception {
		...
		VSMUtil.writeCovarMatrixSem(PsiTPsi, "VBP");
		VSMUtil.writeCovarMatrixSem(PsiTPhi, "VBP");
		VSMUtil.writeCovarMatrixSem(PhiTPhi, "VBP");
		VSMUtil.writeCovarMatrixSem(PhiTPsi, "VBP");
		 ...
		 */
		matrices = VSMUtil.deserializeCCAVariantsRunSem("VBP");
		VSMUtil.writeEigenDictInsideSemantic(matrices, "VBP", d);
		VSMUtil.writeEigenDictOutsideSem(matrices, "VBP", dprime);
		matrices = null;
		PsiTPhi = null;
		PhiTPhi = null;
		PsiTPsi = null;
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValuesSem(s, "VBP");
