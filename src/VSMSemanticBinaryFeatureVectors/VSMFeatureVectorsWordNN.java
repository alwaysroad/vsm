...
public class VSMFeatureVectorsWordNN {
	...
	public static void main(String... args) throws Exception {
		...
		VSMUtil.writeCovarMatrixSem(PsiTPsi, "NN");
		VSMUtil.writeCovarMatrixSem(PsiTPhi, "NN");
		VSMUtil.writeCovarMatrixSem(PhiTPhi, "NN");
		VSMUtil.writeCovarMatrixSem(PhiTPsi, "NN");
		 ...
		 */
		matrices = VSMUtil.deserializeCCAVariantsRunSem("NN");
		VSMUtil.writeEigenDictInsideSemantic(matrices, "NN", d);
		VSMUtil.writeEigenDictOutsideSem(matrices, "NN", dprime);
		matrices = null;
		PsiTPhi = null;
		PhiTPhi = null;
		PsiTPsi = null;
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValuesSem(s, "NN");
