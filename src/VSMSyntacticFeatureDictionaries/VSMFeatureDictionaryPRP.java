...
import VSMFeatureMaps.VSMExtractInsideFeatureDictionaryPRP;
import VSMFeatureMaps.VSMExtractOutsideFeatureDictionaryPRP;
 ...
 *
 */
public class VSMFeatureDictionaryPRP {

	public static void main(String... args) throws Exception {

		System.out.println("***Extracting feature Dictionary for PRP*****");
		/*
		...
		if (args.length > 1) {
			...
			alreadyExistingDictionary = VSMContant.FEATURE_DICT_PRP;
		}
		 ...
		 */
		ExtractDictionary extractInsideDict = new VSMExtractInsideFeatureDictionaryPRP();
		ExtractDictionary extractOutsideDict = new VSMExtractOutsideFeatureDictionaryPRP();
		...
		featureDictionary.serializeFeatureDictionary(dictionaryBean, "prp");

		VSMUtil.writeFeatureDictionary(dictionaryBean, "prp");
