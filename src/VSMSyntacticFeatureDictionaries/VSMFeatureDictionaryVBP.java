...
import VSMFeatureMaps.VSMExtractInsideFeatureDictionaryVBP;
import VSMFeatureMaps.VSMExtractOutsideFeatureDictionaryVBP;
 ...
 *
 */
public class VSMFeatureDictionaryVBP {

	public static void main(String... args) throws Exception {

		System.out.println("***Extracting feature Dictionary for VBP*****");
		/*
		...
		if (args.length > 1) {
			...
			alreadyExistingDictionary = VSMContant.FEATURE_DICT_VBP;
		}
		 ...
		 */
		ExtractDictionary extractInsideDict = new VSMExtractInsideFeatureDictionaryVBP();
		ExtractDictionary extractOutsideDict = new VSMExtractOutsideFeatureDictionaryVBP();
		...
		featureDictionary.serializeFeatureDictionary(dictionaryBean, "vbp");

		VSMUtil.writeFeatureDictionary(dictionaryBean, "vbp");
