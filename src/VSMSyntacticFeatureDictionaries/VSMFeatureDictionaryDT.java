...
import VSMFeatureMaps.VSMExtractInsideFeatureDictionaryDT;

import VSMFeatureMaps.VSMExtractOutsideFeatureDictionaryDT;
 ...
 *
 */
public class VSMFeatureDictionaryDT {

	public static void main(String... args) throws Exception {

		System.out.println("***Extracting feature Dictionary for DT*****");
		/*
		...
		if (args.length > 1) {
			...
			alreadyExistingDictionary = "/afs/inf.ed.ac.uk/group/project/vsm/featuredictionary/dt/dictionary.ser";
		}
		 ...
		 */
		ExtractDictionary extractInsideDict = new VSMExtractInsideFeatureDictionaryDT();
		ExtractDictionary extractOutsideDict = new VSMExtractOutsideFeatureDictionaryDT();
		...
		featureDictionary.serializeFeatureDictionary(dictionaryBean, "dt");
		
		VSMUtil.writeFeatureDictionary(dictionaryBean, "dt");
