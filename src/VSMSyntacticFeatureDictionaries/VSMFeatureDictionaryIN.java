...
import VSMFeatureMaps.VSMExtractInsideFeatureDictionaryIN;
import VSMFeatureMaps.VSMExtractOutsideFeatureDictionaryIN;
 ...
 *
 */
public class VSMFeatureDictionaryIN {

	public static void main(String... args) throws Exception {

		System.out.println("***Extracting feature Dictionary for IN*****");
		/*
		...
		if (args.length > 1) {
			...
			alreadyExistingDictionary = VSMContant.FEATURE_DICT_IN;
		}
		 ...
		 */
		ExtractDictionary extractInsideDict = new VSMExtractInsideFeatureDictionaryIN();
		ExtractDictionary extractOutsideDict = new VSMExtractOutsideFeatureDictionaryIN();
		...
		featureDictionary.serializeFeatureDictionary(dictionaryBean, "in");

		VSMUtil.writeFeatureDictionary(dictionaryBean, "in");
