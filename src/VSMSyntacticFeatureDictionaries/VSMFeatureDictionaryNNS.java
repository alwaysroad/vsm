...
import VSMFeatureMaps.VSMExtractInsideFeatureDictionaryNNS;
import VSMFeatureMaps.VSMExtractOutsideFeatureDictionaryNNS;
 ...
 *
 */
public class VSMFeatureDictionaryNNS {

	public static void main(String... args) throws Exception {

		System.out.println("***Extracting feature Dictionary for NNS*****");
		/*
		...
		if (args.length > 1) {
			...
			alreadyExistingDictionary = VSMContant.FEATURE_DICT_NNS;
		}
		 ...
		 */
		ExtractDictionary extractInsideDict = new VSMExtractInsideFeatureDictionaryNNS();
		ExtractDictionary extractOutsideDict = new VSMExtractOutsideFeatureDictionaryNNS();
		...
		featureDictionary.serializeFeatureDictionary(dictionaryBean, "nns");
		
		VSMUtil.writeFeatureDictionary(dictionaryBean, "nns");
