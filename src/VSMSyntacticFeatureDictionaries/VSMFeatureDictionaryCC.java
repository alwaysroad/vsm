...
import VSMFeatureMaps.VSMExtractInsideFeatureDictionaryCC;
import VSMFeatureMaps.VSMExtractOutsideFeatureDictionaryCC;
 ...
 *
 */
public class VSMFeatureDictionaryCC {

	public static void main(String... args) throws Exception {

		System.out.println("***Extracting feature Dictionary for CC*****");
		/*
		...
		if (args.length > 1) {
			...
			alreadyExistingDictionary = VSMContant.FEATURE_DICT_CC;
		}
		 ...
		 */
		ExtractDictionary extractInsideDict = new VSMExtractInsideFeatureDictionaryCC();
		ExtractDictionary extractOutsideDict = new VSMExtractOutsideFeatureDictionaryCC();
		...
		featureDictionary.serializeFeatureDictionary(dictionaryBean, "cc");

		VSMUtil.writeFeatureDictionary(dictionaryBean, "cc");
