...
import VSMFeatureMaps.VSMExtractInsideFeatureDictionaryS;
import VSMFeatureMaps.VSMExtractOutsideFeatureDictionaryS;
 ...
 *
 */
public class VSMFeatureDictionaryS {

	public static void main(String... args) throws Exception {

		System.out.println("***Extracting feature Dictionary for S*****");
		/*
		...
		if (args.length > 1) {
			...
			alreadyExistingDictionary = VSMContant.FEATURE_DICT_S;
		}
		 ...
		 */
		ExtractDictionary extractInsideDict = new VSMExtractInsideFeatureDictionaryS();
		ExtractDictionary extractOutsideDict = new VSMExtractOutsideFeatureDictionaryS();
		...
		featureDictionary.serializeFeatureDictionary(dictionaryBean, "s");
		
		VSMUtil.writeFeatureDictionary(dictionaryBean, "s");
