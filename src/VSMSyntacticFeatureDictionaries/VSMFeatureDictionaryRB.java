...
import VSMFeatureMaps.VSMExtractInsideFeatureDictionaryRB;
import VSMFeatureMaps.VSMExtractOutsideFeatureDictionaryRB;
 ...
 *
 */
public class VSMFeatureDictionaryRB {

	public static void main(String... args) throws Exception {

		System.out.println("***Extracting feature Dictionary for RB*****");
		/*
		...
		if (args.length > 1) {
			...
			alreadyExistingDictionary = VSMContant.FEATURE_DICT_RB;
		}
		 ...
		 */
		ExtractDictionary extractInsideDict = new VSMExtractInsideFeatureDictionaryRB();
		ExtractDictionary extractOutsideDict = new VSMExtractOutsideFeatureDictionaryRB();
		...
		featureDictionary.serializeFeatureDictionary(dictionaryBean, "rb");

		VSMUtil.writeFeatureDictionary(dictionaryBean, "rb");
