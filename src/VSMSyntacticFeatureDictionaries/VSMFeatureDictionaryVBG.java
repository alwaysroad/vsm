...
import VSMFeatureMaps.VSMExtractInsideFeatureDictionaryVBG;
import VSMFeatureMaps.VSMExtractOutsideFeatureDictionaryVBG;
 ...
 *
 */
public class VSMFeatureDictionaryVBG {

	public static void main(String... args) throws Exception {

		System.out.println("***Extracting feature Dictionary for VBG*****");
		/*
		...
		if (args.length > 1) {
			...
			alreadyExistingDictionary = VSMContant.FEATURE_DICT_VBG;
		}
		 ...
		 */
		ExtractDictionary extractInsideDict = new VSMExtractInsideFeatureDictionaryVBG();
		ExtractDictionary extractOutsideDict = new VSMExtractOutsideFeatureDictionaryVBG();
		...
		featureDictionary.serializeFeatureDictionary(dictionaryBean, "vbg");

		VSMUtil.writeFeatureDictionary(dictionaryBean, "vbg");
