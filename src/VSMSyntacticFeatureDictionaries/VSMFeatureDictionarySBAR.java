...
import VSMFeatureMaps.VSMExtractInsideFeatureDictionarySBAR;
import VSMFeatureMaps.VSMExtractOutsideFeatureDictionarySBAR;
 ...
 *
 */
public class VSMFeatureDictionarySBAR {

	public static void main(String... args) throws Exception {

		System.out.println("***Extracting feature Dictionary for SBAR*****");
		/*
		...
		if (args.length > 1) {
			...
			alreadyExistingDictionary = VSMContant.FEATURE_DICT_SBAR;
		}
		 ...
		 */
		ExtractDictionary extractInsideDict = new VSMExtractInsideFeatureDictionarySBAR();
		ExtractDictionary extractOutsideDict = new VSMExtractOutsideFeatureDictionarySBAR();
		...
		featureDictionary.serializeFeatureDictionary(dictionaryBean, "sbar");

		VSMUtil.writeFeatureDictionary(dictionaryBean, "sbar");
