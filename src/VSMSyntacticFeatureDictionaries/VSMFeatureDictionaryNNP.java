...
import VSMFeatureMaps.VSMExtractInsideFeatureDictionaryNNP;
import VSMFeatureMaps.VSMExtractOutsideFeatureDictionaryNNP;
 ...
 *
 */
public class VSMFeatureDictionaryNNP {

	public static void main(String... args) throws Exception {

		System.out.println("***Extracting feature Dictionary for NNP*****");
		/*
		...
		if (args.length > 1) {
			...
			alreadyExistingDictionary = VSMContant.FEATURE_DICT_NNP;
		}
		 ...
		 */
		ExtractDictionary extractInsideDict = new VSMExtractInsideFeatureDictionaryNNP();
		ExtractDictionary extractOutsideDict = new VSMExtractOutsideFeatureDictionaryNNP();
		...
		featureDictionary.serializeFeatureDictionary(dictionaryBean, "nnp");

		VSMUtil.writeFeatureDictionary(dictionaryBean, "nnp");
