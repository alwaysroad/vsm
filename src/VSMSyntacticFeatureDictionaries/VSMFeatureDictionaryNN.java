...
import VSMFeatureMaps.VSMExtractInsideFeatureDictionaryNN;
import VSMFeatureMaps.VSMExtractOutsideFeatureDictionaryNN;
 ...
 *
 */
public class VSMFeatureDictionaryNN {

	public static void main(String... args) throws Exception {

		System.out.println("***Extracting feature Dictionary for NN*****");
		/*
		...
		if (args.length > 1) {
			...
			alreadyExistingDictionary = VSMContant.FEATURE_DICT_NN;
		}
		 ...
		 */
		ExtractDictionary extractInsideDict = new VSMExtractInsideFeatureDictionaryNN();
		ExtractDictionary extractOutsideDict = new VSMExtractOutsideFeatureDictionaryNN();
		...
		featureDictionary.serializeFeatureDictionary(dictionaryBean, "nn");

		VSMUtil.writeFeatureDictionary(dictionaryBean, "nn");
