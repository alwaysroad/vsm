...
import VSMFeatureMaps.VSMExtractInsideFeatureDictionaryNP;
import VSMFeatureMaps.VSMExtractOutsideFeatureDictionaryNP;
 ...
 *
 */
public class VSMFeatureDictionaryNP {

	public static void main(String... args) throws Exception {

		System.out.println("***Extracting feature Dictionary for NP*****");
		/*
		...
		if (args.length > 1) {
			...
			alreadyExistingDictionary = VSMContant.FEATURE_DICT_NP;
		}
		 ...
		 */
		ExtractDictionary extractInsideDict = new VSMExtractInsideFeatureDictionaryNP();
		ExtractDictionary extractOutsideDict = new VSMExtractOutsideFeatureDictionaryNP();
		...
		featureDictionary.serializeFeatureDictionary(dictionaryBean, "np");

		VSMUtil.writeFeatureDictionary(dictionaryBean, "np");
