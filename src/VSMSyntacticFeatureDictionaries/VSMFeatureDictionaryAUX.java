...
import VSMFeatureMaps.VSMExtractInsideFeatureDictionaryAUX;

import VSMFeatureMaps.VSMExtractOutsideFeatureDictionaryAUX;
 ...
 *
 */
public class VSMFeatureDictionaryAUX {

	public static void main(String... args) throws Exception {

		System.out.println("***Extracting feature Dictionary for AUX*****");
		/*
		...
		if (args.length > 1) {
			...
			rootDirectory = "/afs/inf.ed.ac.uk/group/project/vsm/trees/";
			alreadyExistingDictionary = "/afs/inf.ed.ac.uk/group/project/vsm/featuredictionary/aux/dictionary.ser";
		}
		 ...
		 */
		ExtractDictionary extractInsideDict = new VSMExtractInsideFeatureDictionaryAUX();
		ExtractDictionary extractOutsideDict = new VSMExtractOutsideFeatureDictionaryAUX();
		...
		featureDictionary.serializeFeatureDictionary(dictionaryBean, "aux");

		/*
		 * Write the dictionary to a text file so that we can see what we are
		 * doing
		 */
		VSMUtil.writeFeatureDictionary(dictionaryBean, "aux");
