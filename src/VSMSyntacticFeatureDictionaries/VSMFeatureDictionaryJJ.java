...
import VSMFeatureMaps.VSMExtractInsideFeatureDictionaryJJ;
import VSMFeatureMaps.VSMExtractOutsideFeatureDictionaryJJ;
...
public class VSMFeatureDictionaryJJ {
	
	private static Logger LOGGER;

	public static void main(String... args) throws Exception {

		System.out.println("***Extracting feature Dictionary for JJ*****");
		...
		if (args.length > 1) {
			...
			alreadyExistingDictionary = VSMContant.FEATURE_DICT_JJ;
		}
		 ...
		 */
		ExtractDictionary extractInsideDict = new VSMExtractInsideFeatureDictionaryJJ();
		ExtractDictionary extractOutsideDict = new VSMExtractOutsideFeatureDictionaryJJ();
		...
		featureDictionary.serializeFeatureDictionary(dictionaryBean, "jj");

		VSMUtil.writeFeatureDictionary(dictionaryBean, "jj");
