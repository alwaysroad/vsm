...
import VSMFeatureMaps.VSMExtractInsideFeatureDictionaryVP;
import VSMFeatureMaps.VSMExtractOutsideFeatureDictionaryVP;
 ...
 *
 */
public class VSMFeatureDictionaryVP {

	public static void main(String... args) throws Exception {

		System.out.println("***Extracting feature Dictionary for VP*****");
		/*
		...
		if (args.length > 1) {
			...
			alreadyExistingDictionary = VSMContant.FEATURE_DICT_VP;
		}
		 ...
		 */
		ExtractDictionary extractInsideDict = new VSMExtractInsideFeatureDictionaryVP();
		ExtractDictionary extractOutsideDict = new VSMExtractOutsideFeatureDictionaryVP();
		...
		featureDictionary.serializeFeatureDictionary(dictionaryBean, "vp");
		
		VSMUtil.writeFeatureDictionary(dictionaryBean, "vp");
