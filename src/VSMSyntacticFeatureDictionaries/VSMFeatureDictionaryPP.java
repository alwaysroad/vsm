...
import VSMFeatureMaps.VSMExtractInsideFeatureDictionaryPP;
import VSMFeatureMaps.VSMExtractOutsideFeatureDictionaryPP;
 ...
 *
 */
public class VSMFeatureDictionaryPP {

	public static void main(String... args) throws Exception {

		System.out.println("***Extracting feature Dictionary for PP*****");
		...
		if (args.length > 1) {
			...
			alreadyExistingDictionary = VSMContant.FEATURE_DICT_PP;
		}
		 ...
		 */
		ExtractDictionary extractInsideDict = new VSMExtractInsideFeatureDictionaryPP();
		ExtractDictionary extractOutsideDict = new VSMExtractOutsideFeatureDictionaryPP();
		...
		featureDictionary.serializeFeatureDictionary(dictionaryBean, "pp");

		VSMUtil.writeFeatureDictionary(dictionaryBean, "pp");
