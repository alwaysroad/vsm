...
public class CopyOfVSMSerializeFeatureVectorBeanWord {
	 ...
	 * No args constructor
	 */
	public CopyOfVSMSerializeFeatureVectorBeanWord() {
	...
	public CopyOfVSMSerializeFeatureVectorBeanWord(
		...
		CopyOfVSMSerializeFeatureVectorBeanWord.countMap = countMap;
		count = 0;
	}
	...
	public void serializeWordVectorBean(VSMWordFeatureVectorBean vectorBean) {
		...
		if (count <= 30000) {
			...
			file = new File(
					"/afs/inf.ed.ac.uk/group/project/vsm/wordfeaturevec/"
							+ vectorBean.getLabel() + "/"
