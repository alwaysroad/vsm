...
public class VSMSerializeFeatureVectorBean {
	 ...
	 * No args constructor
	 */
	public VSMSerializeFeatureVectorBean() {
	...
	public VSMSerializeFeatureVectorBean(LinkedHashMap<String, Integer> countMap) {
		VSMSerializeFeatureVectorBean.countMap = countMap;
		count = 0;
	}

	public boolean serializeVectorBean(VSMFeatureVectorBean vectorBean) {
		...
		if (count <= 30000) {
			...
			file = new File(
					"/afs/inf.ed.ac.uk/group/project/vsm.restored/sparsefeaturevectorssyntactic/"
							+ vectorBean.getLabel() + "/"
			...
			file = new File(
					"/afs/inf.ed.ac.uk/group/project/vsm/sparsefeaturevectorssyntactic/"
							+ vectorBean.getLabel() + "/"
