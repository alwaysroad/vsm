...
public class VSMFeatureMatrixJJ {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		String dictionaryPath = "/afs/inf.ed.ac.uk/group/project/vsm/featuredictionary/jj/dictionary.ser";
		/*
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm/sparsefeaturevectorssyntactic/JJ/";
		/*
		...
		VSMUtil.writeCovarMatrix(PsiTPsi, "JJ");
		VSMUtil.writeCovarMatrix(PsiTPhi, "JJ");
		VSMUtil.writeCovarMatrix(PhiTPhi, "JJ");
		VSMUtil.writeCovarMatrix(PhiTPsi, "JJ");
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValues(s, "JJ");
