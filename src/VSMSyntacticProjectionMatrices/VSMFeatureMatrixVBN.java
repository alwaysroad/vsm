...
public class VSMFeatureMatrixVBN {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		System.out.println("Hi: I am VBN");
		...
		String dictionaryPath = "/afs/inf.ed.ac.uk/group/project/vsm.restored/featuredictionary/vbn/dictionary.ser";
		/*
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm.restored/sparsefeaturevectorssyntactic/VBN/";
		/*
		...
		VSMUtil.writeCovarMatrix(PsiTPsi, "VBN");
		VSMUtil.writeCovarMatrix(PsiTPhi, "VBN");
		VSMUtil.writeCovarMatrix(PhiTPhi, "VBN");
		VSMUtil.writeCovarMatrix(PhiTPsi, "VBN");
		 ...
		 */
		matrices = VSMUtil.deserializeCCAVariantsRun("VBN");
		VSMUtil.writeEigenDictInside(matrices, "VBN", d);
		VSMUtil.writeEigenDictOutside(matrices, "VBN", dprime);
		matrices = null;
		PsiTPhi = null;
		PhiTPhi = null;
		PsiTPsi = null;
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValues(s, "VBN");
