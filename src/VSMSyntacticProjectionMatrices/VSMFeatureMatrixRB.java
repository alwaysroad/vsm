...
public class VSMFeatureMatrixRB {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		String dictionaryPath = "/afs/inf.ed.ac.uk/group/project/vsm.restored/featuredictionary/rb/dictionary.ser";
		/*
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm.restored/sparsefeaturevectorssyntactic/RB/";
		/*
		...
		VSMUtil.writeCovarMatrix(PsiTPsi, "RB");
		VSMUtil.writeCovarMatrix(PsiTPhi, "RB");
		VSMUtil.writeCovarMatrix(PhiTPhi, "RB");
		VSMUtil.writeCovarMatrix(PhiTPsi, "RB");
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValues(s, "RB");
