...
public class VSMFeatureMatrixCC {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		String dictionaryPath = VSMContant.FEATURE_DICT_CC;
		/*
		...
		String direct = VSMContant.SPARSE_SYNTACTIC_FEATURRE_VECS + "/CC/";
		/*
		...
		VSMUtil.writeCovarMatrix(PsiTPsi, "CC");
		VSMUtil.writeCovarMatrix(PsiTPhi, "CC");
		VSMUtil.writeCovarMatrix(PhiTPhi, "CC");
		VSMUtil.writeCovarMatrix(PhiTPsi, "CC");
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValues(s, "CC");
