...
public class VSMFeatureMatrixVBG {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		System.out.println("Hi: I am VBG");
		...
		String dictionaryPath = VSMContant.FEATURE_DICT_VBG;
		/*
		...
		String direct = VSMContant.SPARSE_SYNTACTIC_FEATURRE_VECS + "/VBG/";
		/*
		...
		VSMUtil.writeCovarMatrix(PsiTPsi, "VBG");
		VSMUtil.writeCovarMatrix(PsiTPhi, "VBG");
		VSMUtil.writeCovarMatrix(PhiTPhi, "VBG");
		VSMUtil.writeCovarMatrix(PhiTPsi, "VBG");
		 ...
		 */
		matrices = VSMUtil.deserializeCCAVariantsRun("VBG");
		VSMUtil.writeEigenDictInside(matrices, "VBG", d);
		VSMUtil.writeEigenDictOutside(matrices, "VBG", dprime);
		matrices = null;
		PsiTPhi = null;
		PhiTPhi = null;
		PsiTPsi = null;
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValues(s, "VBG");
