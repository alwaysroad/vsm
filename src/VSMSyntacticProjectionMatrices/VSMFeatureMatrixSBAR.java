...
public class VSMFeatureMatrixSBAR {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		String dictionaryPath = "/afs/inf.ed.ac.uk/group/project/vsm.restored/featuredictionary/sbar/dictionary.ser";
		/*
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm.restored/sparsefeaturevectorssyntactic/SBAR/";
		/*
		...
		VSMUtil.writeCovarMatrix(PsiTPsi, "SBAR");
		VSMUtil.writeCovarMatrix(PsiTPhi, "SBAR");
		VSMUtil.writeCovarMatrix(PhiTPhi, "SBAR");
		VSMUtil.writeCovarMatrix(PhiTPsi, "SBAR");
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValues(s, "SBAR");
