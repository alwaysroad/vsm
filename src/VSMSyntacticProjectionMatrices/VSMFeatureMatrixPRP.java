...
public class VSMFeatureMatrixPRP {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		System.out.println("Hi: I am PRP");
		...
		String dictionaryPath = "/afs/inf.ed.ac.uk/group/project/vsm.restored/featuredictionary/prp/dictionary.ser";
		/*
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm.restored/sparsefeaturevectorssyntactic/PRP/";
		/*
		...
		VSMUtil.writeCovarMatrix(PsiTPsi, "PRP");
		VSMUtil.writeCovarMatrix(PsiTPhi, "PRP");
		VSMUtil.writeCovarMatrix(PhiTPhi, "PRP");
		VSMUtil.writeCovarMatrix(PhiTPsi, "PRP");
		 ...
		 */
		matrices = VSMUtil.deserializeCCAVariantsRun("PRP");
		VSMUtil.writeEigenDictInside(matrices, "PRP", d);
		VSMUtil.writeEigenDictOutside(matrices, "PRP", dprime);
		matrices = null;
		PsiTPhi = null;
		PhiTPhi = null;
		PsiTPsi = null;
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValues(s, "PRP");
	...
	/**
	 * Important method used in compute CCA, Why take just the diagonals? In
	 * case of words it makes sense perhaps but not in our case where we do not
	 * have a one hot representation, but instead have a full covariance matrix.
