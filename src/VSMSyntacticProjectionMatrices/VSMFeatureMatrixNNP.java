...
public class VSMFeatureMatrixNNP {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		System.out.println("Hi: I am NNP");
		...
		String dictionaryPath = "/afs/inf.ed.ac.uk/group/project/vsm/featuredictionary/nnp/dictionary.ser";
		/*
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm/sparsefeaturevectorssyntactic/NNP/";
		/*
		...
		VSMUtil.writeCovarMatrix(PsiTPsi, "NNP");
		VSMUtil.writeCovarMatrix(PsiTPhi, "NNP");
		VSMUtil.writeCovarMatrix(PhiTPhi, "NNP");
		VSMUtil.writeCovarMatrix(PhiTPsi, "NNP");
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValues(s, "NNP");
