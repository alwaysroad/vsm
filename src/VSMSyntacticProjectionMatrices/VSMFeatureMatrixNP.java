...
public class VSMFeatureMatrixNP {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		String dictionaryPath = VSMContant.FEATURE_DICT_NP;
		/*
		...
		String direct = VSMContant.SPARSE_SYNTACTIC_FEATURRE_VECS + "/NP/";
		/*
		...
		VSMUtil.writeCovarMatrix(PsiTPsi, "NP");
		VSMUtil.writeCovarMatrix(PsiTPhi, "NP");
		VSMUtil.writeCovarMatrix(PhiTPhi, "NP");
		VSMUtil.writeCovarMatrix(PhiTPsi, "NP");
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValues(s, "NP");
