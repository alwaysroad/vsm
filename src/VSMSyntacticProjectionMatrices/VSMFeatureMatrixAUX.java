...
public class VSMFeatureMatrixAUX {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm/sparsefeaturevectorssyntactic/AUX/";
		/*
		...
		VSMUtil.writeCovarMatrix(PsiTPsi, "AUX");
		VSMUtil.writeCovarMatrix(PsiTPhi, "AUX");
		VSMUtil.writeCovarMatrix(PhiTPhi, "AUX");
		VSMUtil.writeCovarMatrix(PhiTPsi, "AUX");
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValues(s, "AUX");
