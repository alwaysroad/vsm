...
public class VSMFeatureMatrixVP {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		String dictionaryPath = VSMContant.FEATURE_DICT_VP;
		/*
		...
		String direct = VSMContant.SPARSE_SYNTACTIC_FEATURRE_VECS + "/VP/";
		/*
		...
		VSMUtil.writeCovarMatrix(PsiTPsi, "VP");
		VSMUtil.writeCovarMatrix(PsiTPhi, "VP");
		VSMUtil.writeCovarMatrix(PhiTPhi, "VP");
		VSMUtil.writeCovarMatrix(PhiTPsi, "VP");
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValues(s, "VP");
