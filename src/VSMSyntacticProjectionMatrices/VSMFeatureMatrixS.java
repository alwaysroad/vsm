...
public class VSMFeatureMatrixS {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		String dictionaryPath = "/afs/inf.ed.ac.uk/group/project/vsm/featuredictionary/s/dictionary.ser";
		/*
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm/sparsefeaturevectorssyntactic/S/";
		/*
		...
		VSMUtil.writeCovarMatrix(PsiTPsi, "S");
		VSMUtil.writeCovarMatrix(PsiTPhi, "S");
		VSMUtil.writeCovarMatrix(PhiTPhi, "S");
		VSMUtil.writeCovarMatrix(PhiTPsi, "S");
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValues(s, "S");
