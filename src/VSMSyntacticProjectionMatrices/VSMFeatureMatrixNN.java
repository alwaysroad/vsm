...
public class VSMFeatureMatrixNN {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		String dictionaryPath = "/afs/inf.ed.ac.uk/group/project/vsm.restored/featuredictionary/nn/dictionary.ser";
		/*
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm.restored/sparsefeaturevectorssyntactic/NN/";
		/*
		...
		VSMUtil.writeCovarMatrix(PsiTPsi, "NN");
		VSMUtil.writeCovarMatrix(PsiTPhi, "NN");
		VSMUtil.writeCovarMatrix(PhiTPhi, "NN");
		VSMUtil.writeCovarMatrix(PhiTPsi, "NN");
		 ...
		 */
		matrices = VSMUtil.deserializeCCAVariantsRun("NN");
		VSMUtil.writeEigenDictInside(matrices, "NN", d);
		VSMUtil.writeEigenDictOutside(matrices, "NN", dprime);
		matrices = null;
		PsiTPhi = null;
		PhiTPhi = null;
		PsiTPsi = null;
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValues(s, "NN");
