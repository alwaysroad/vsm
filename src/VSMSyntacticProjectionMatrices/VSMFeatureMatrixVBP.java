...
public class VSMFeatureMatrixVBP {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		System.out.println("Hi: I am VBP");
		...
		String dictionaryPath = "/afs/inf.ed.ac.uk/group/project/vsm.restored/featuredictionary/vbp/dictionary.ser";
		/*
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm.restored/sparsefeaturevectorssyntactic/VBP/";
		/*
		...
		VSMUtil.writeCovarMatrix(PsiTPsi, "VBP");
		VSMUtil.writeCovarMatrix(PsiTPhi, "VBP");
		VSMUtil.writeCovarMatrix(PhiTPhi, "VBP");
		VSMUtil.writeCovarMatrix(PhiTPsi, "VBP");
		 ...
		 */
		matrices = VSMUtil.deserializeCCAVariantsRun("VBP");
		VSMUtil.writeEigenDictInside(matrices, "VBP", d);
		VSMUtil.writeEigenDictOutside(matrices, "VBP", dprime);
		matrices = null;
		PsiTPhi = null;
		PhiTPhi = null;
		PsiTPsi = null;
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValues(s, "VBP");
