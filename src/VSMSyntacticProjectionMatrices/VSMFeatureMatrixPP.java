...
public class VSMFeatureMatrixPP {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		String dictionaryPath = VSMContant.FEATURE_DICT_PP;
		/*
		...
		String direct = VSMContant.SPARSE_SYNTACTIC_FEATURRE_VECS + "/PP/";
		/*
		...
		VSMUtil.writeCovarMatrix(PsiTPsi, "PP");
		VSMUtil.writeCovarMatrix(PsiTPhi, "PP");
		VSMUtil.writeCovarMatrix(PhiTPhi, "PP");
		VSMUtil.writeCovarMatrix(PhiTPsi, "PP");
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValues(s, "PP");
