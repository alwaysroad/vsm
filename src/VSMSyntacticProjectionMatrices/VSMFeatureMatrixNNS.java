...
public class VSMFeatureMatrixNNS {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		System.out.println("Hi: I am NNS");
		...
		String dictionaryPath = "/afs/inf.ed.ac.uk/group/project/vsm/featuredictionary/nns/dictionary.ser";
		/*
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm/sparsefeaturevectorssyntactic/NNS/";
		/*
		...
		VSMUtil.writeCovarMatrix(PsiTPsi, "NNS");
		VSMUtil.writeCovarMatrix(PsiTPhi, "NNS");
		VSMUtil.writeCovarMatrix(PhiTPhi, "NNS");
		VSMUtil.writeCovarMatrix(PhiTPsi, "NNS");
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValues(s, "NNS");
