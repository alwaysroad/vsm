...
public class VSMFeatureMatrixDT {
	...
	public static void main(String... args) throws ClassNotFoundException,
		...
		String dictionaryPath = VSMContant.FEATURE_DICT_DT;
		/*
		...
		String direct = "/afs/inf.ed.ac.uk/group/project/vsm.restored/sparsefeaturevectorssyntactic/DT/";
		/*
		...
		VSMUtil.writeCovarMatrix(PsiTPsi, "DT");
		VSMUtil.writeCovarMatrix(PsiTPhi, "DT");
		VSMUtil.writeCovarMatrix(PhiTPhi, "DT");
		VSMUtil.writeCovarMatrix(PhiTPsi, "DT");
	...
	private static void computeCCA2(FlexCompRowMatrix xty,
		 ...
		 */
		VSMUtil.writeSingularValues(s, "DT");
